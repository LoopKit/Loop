...
extension Notification.Name {
    static let darkModeEnabled = Notification.Name("loopkit.Loop.LoopUI.notifications.darkModeEnabled")
    static let darkModeDisabled = Notification.Name("loopkit.Loop.LoopUI.notifications.darkModeDisabled")
}
//DarkMode
