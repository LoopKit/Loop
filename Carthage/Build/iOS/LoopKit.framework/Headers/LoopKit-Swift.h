...
- (nonnull instancetype)initWithCommand:(NSString * _Nonnull (^ _Nonnull)(void (^ _Nonnull)(NSString * _Nonnull)))command OBJC_DESIGNATED_INITIALIZER;
...
- (id _Nullable)activityViewController:(UIActivityViewController * _Nonnull)activityViewController itemForActivityType:(UIActivityType _Nonnull)activityType;
- (NSString * _Nonnull)activityViewController:(UIActivityViewController * _Nonnull)activityViewController subjectForActivityType:(UIActivityType _Nullable)activityType;
@end
...
*/
- (void)presentAlertControllerWith:(NSError * _Nonnull)error animated:(BOOL)animated completion:(void (^ _Nullable)(void))completion;
/**
