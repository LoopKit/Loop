...
@interface NSData (SWIFT_EXTENSION(Crypto))
@property (nonatomic, readonly, strong) NSData * _Nonnull MD2;
@property (nonatomic, readonly, strong) NSData * _Nonnull MD4;
@property (nonatomic, readonly, strong) NSData * _Nonnull MD5;
