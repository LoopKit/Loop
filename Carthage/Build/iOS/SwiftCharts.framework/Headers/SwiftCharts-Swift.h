...
- (nonnull instancetype)initWithPoints:(NSArray<NSValue *> * _Nonnull)points frame:(CGRect)frame color:(UIColor * _Nonnull)color animDuration:(float)animDuration animDelay:(float)animDelay OBJC_DESIGNATED_INITIALIZER;
...
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)didMoveToSuperview;
- (nonnull instancetype)initWithP1:(CGPoint)p1 p2:(CGPoint)p2 width:(CGFloat)width bgColor:(UIColor * _Nullable)bgColor animDuration:(float)animDuration SWIFT_UNAVAILABLE;
@end
